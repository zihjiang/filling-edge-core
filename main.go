...
import (
	...
	_ "datacollector-edge/stages/destinations"
...
func (p *program) run() {
	...
	fmt.Println("Data Collector Edge (SDC Edge): ")
...
func main() {
	...
	svcConfig := &service.Config{
		...
		DisplayName: "Data Collector Edge Service",
...
func getBaseDir() string {
	...
	baseDir = "/Users/jiangzihan/gitHub/datacollector-edge/resources"
	return baseDir
}
