...
const (
	...
	APACHE_KAFKA_2_7_LIBRARY  = "streamsets-datacollector-apache-kafka_2_7-lib"
...
func init() {
	...
	stagelibrary.SetCreator(APACHE_KAFKA_2_7_LIBRARY, StageName, func() api.Stage {
		return &KafkaDestination{BaseStage: &common.BaseStage{}, kafkaVersion: sarama.V2_7_0_0}
	})
